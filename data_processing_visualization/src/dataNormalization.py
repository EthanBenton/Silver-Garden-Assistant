...
plt.ylim(0, 50)
plt.text(0.85, (temperature_q1) - 1.4, f'Q1: {temperature_q1:.2f}', va='center', ha='center', backgroundcolor='w')
plt.text(0.85, (temperature_q3) + 1.4, f'Q3: {temperature_q3:.2f}', va='center', ha='center', backgroundcolor='w')
plt.text(1.2, (temperature_q1 + temperature_q3) / 2, f'IQR: {temperature_iqr:.2f}', va='center', ha='center', backgroundcolor='w')
...
plt.ylabel('Humidity (%)')
plt.ylim(0, 100) 
plt.text(0.85, (humidity_q1) - 3, f'Q1: {humidity_q1:.2f}', va='center', ha='center', backgroundcolor='w')
plt.text(0.85, (humidity_q3) + 3, f'Q3: {humidity_q3:.2f}', va='center', ha='center', backgroundcolor='w')
plt.text(1.2, (humidity_q1 + humidity_q3) / 2, f'IQR: {humidity_iqr:.2f}', va='center', ha='center', backgroundcolor='w')

plt.tight_layout()  # Adjust a layout to prevent it from overlapping
plt.show()
